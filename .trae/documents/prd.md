...
2. **今日收款记录**：按时间顺序展示所有已收款记录，支持按付款方式汇总
3. **分期收款管理**：分期定金模式下支持录入定金金额、剩余尾款、下次到店提醒
4. **打印预览**：收费明细打印页面，供患者签字确认
...
| 收银主窗口 | 收款备注 | 选择付款方式（现金/扫码/分期定金），分期定金模式下可录入定金金额、剩余尾款、下次到店提醒；填写优惠来源（会员价/院长特批/团购核销），优惠来源切回"无优惠"时优惠金额自动清零；备注信息，确认收款 |
| 收银主窗口 | 今日收款记录 | 展示今日已收款清单，包含患者、套餐、实收、付款方式、优惠来源、收费时间；支持按付款方式汇总显示现金/扫码/分期定金合计金额 |
| 收银主窗口 | 打印功能 | 确认收款前/后均可打印；打印内容包含收款状态、收费时间、分期信息、患者签字栏 |
